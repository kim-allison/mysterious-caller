...
# engine = GrammarEngine('./grammar/component1Grammar.txt')
# recursive_parser = RecursiveDescentParser(engine.grammar)
# parse_tree = recursive_parser.parse("Joe said Buster ghosted Schiller", "Joe")
# print("\nTREE1:", parse_tree)